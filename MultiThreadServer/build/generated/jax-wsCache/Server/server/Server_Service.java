 ...
 * 
 */
@WebServiceClient(name = "Server", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/1DZ_RASUS_Server/Server?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/1DZ_RASUS_Server/Server?wsdl");
